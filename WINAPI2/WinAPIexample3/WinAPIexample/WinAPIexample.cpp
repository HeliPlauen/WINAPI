...
LRESULT WINAPI WndProc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam) {
	...
	case WM_KEYDOWN: {               // When any key was pressed		
		...
		case VK_TAB: {
			int message = MessageBox(NULL, L"tab", L"app", MB_YESNO | MB_ICONERROR);
			switch (message) {
			case IDYES: {
				MessageBox(NULL, L"You pressed YES", L"app", NULL);
				break;
			}
			case IDNO: {
				MessageBox(NULL, L"You pressed NO", L"app", NULL);
				break;
			}
			}
			break;
		...
		case VK_SHIFT: {
			int message = MessageBox(hwnd, L"shift", L"app", MB_YESNOCANCEL | MB_ICONQUESTION);
			switch (message) {
			case IDYES: {
				MessageBox(NULL, L"You pressed YES", L"app", NULL);
				break;
			...
			case IDCANCEL: {
				MessageBox(NULL, L"You pressed BREAK", L"app", NULL);
				break;
			}
			}
			break;
